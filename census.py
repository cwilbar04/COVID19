...
def load_census_data():
   ...
   -------
    ...
    File downloaded locally to repository. Function must be run from cloned repository to work correctly.
    
    See https://www.census.gov/data/datasets/time-series/demo/popest/2010s-counties-total.html for more info on dataset.
    """

    # Import Census data from local file using relative path loading only relevant columns to speed up performance
